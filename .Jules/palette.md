...
## 2026-06-16 - Non-blocking Toast Notifications
...
**Action:** Only apply modality and focus-stealing to explicit, blocking dialogs. Remove `grab_set()` from transient popup elements.
