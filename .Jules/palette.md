...
## 2026-06-30 - Non-Blocking Transient Notifications
...
**Action:** Only apply modality and focus-stealing to explicit, blocking dialogs. Never use `grab_set()` on temporary ToastPopups.
