...
**Action:** Always explicitly set `cursor="hand2"` on reusable interactive components (like `ActionButton` wrapping `CTkButton`) to ensure users receive clear visual indication that the element is clickable.
