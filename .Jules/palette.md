...
## 2024-06-05 - Non-blocking Toast Notifications
**Learning:** In CustomTkinter, applying `grab_set()` to transient notifications (like auto-dismissing toasts) creates a severe UX regression by interrupting user workflow.
**Action:** Only apply modality and focus-stealing to explicit, blocking dialogs. Ensure auto-dismissing notifications remain passive.
