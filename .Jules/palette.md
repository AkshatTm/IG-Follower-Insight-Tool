...
## 2024-06-21 - Non-blocking Transient Notifications
...
**Action:** Only apply modality and focus-stealing to explicit, blocking dialogs. Ensure temporary notifications like `ToastPopup` remain purely informational and non-blocking.
