...
## 2024-06-15 - Remove Modality from Transient Toasts
**Learning:** Applying grab_set() or focus_set() to transient notifications (like auto-dismissing toasts) creates a severe UX regression by interrupting user workflow. Modality should only be applied to explicit, blocking dialogs.
**Action:** Never use grab_set() on temporary, informational CTkToplevel popup widgets.
