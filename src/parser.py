...
# Pre-compile the regex pattern used for username sanitization.
# This prevents recompilation overhead when extracting thousands of usernames.
    ...
    try:
        ...
        if isinstance(sld, list) and len(sld) > 0:
            ...
            if isinstance(value, str) and value.strip():
                ...
                clean_value = _USERNAME_CLEAN_RE.sub('', value.strip()[:max_len])
                if clean_value:
                    return clean_value
