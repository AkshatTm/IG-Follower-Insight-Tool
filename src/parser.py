...
# Pre-compile regex for performance during high-volume JSON parsing
_RE_SANITIZE = re.compile(r'[^a-zA-Z0-9._]')
    ...
    try:
        ...
        if isinstance(sld, list) and len(sld) > 0:
            ...
            if isinstance(value, str) and value.strip():
                ...
                clean_value = _RE_SANITIZE.sub('', value.strip()[:max_len])
                if clean_value:
                    return clean_value
