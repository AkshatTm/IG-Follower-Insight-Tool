...
# [PERFORMANCE] Pre-compile regex to prevent redundant compilation in high-volume operations
USERNAME_CLEANUP_RE = re.compile(r'[^a-zA-Z0-9._]')
    ...
    try:
        ...
        if isinstance(sld, list) and len(sld) > 0:
            ...
            if isinstance(value, str) and value.strip():
                ...
                clean_value = USERNAME_CLEANUP_RE.sub('', value.strip()[:max_len])
                if clean_value:
                    return clean_value
