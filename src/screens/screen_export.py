...
Final screen presenting the filtered unfollow list and export tools.
"""
...
class ScreenExport(ctk.CTkFrame):
    """Screen 4 - Final summary and export actions."""
    ...
    def _build_hero(self, parent):
        ...
        summary_label = ctk.CTkLabel(
            hero_inner,
            text=f"Final Count: {self.final_count} Users to Unfollow",
            font=Fonts.SUBHEADING,
            text_color=Colors.TEXT_PRIMARY,
        )
        summary_label.pack(pady=(0, Spacing.SM))
    ...
    def _on_copy_clipboard(self):
        if self.final_count == 0:
            ToastPopup(
                ...
                message="All users are whitelisted. There is nothing to copy.",
                toast_type="info",
                duration_ms=3000,
            )
            return
