...
class ScreenFilter(ctk.CTkFrame):
    ...
    def __init__(self, master, app):
        ...
        # Track rendered row widgets for reuse
        # ⚡ Boltu: Replaced dict with list pool to prevent layout block on destroy
        self._row_pool = []
    ...
    def _populate_rows(self, clear=False):
        ...
        start_idx = 0 if clear else self._visible_limit - self.PAGE_SIZE
        if start_idx < 0:
            start_idx = 0
