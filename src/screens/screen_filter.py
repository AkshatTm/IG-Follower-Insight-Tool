...
class ScreenFilter(ctk.CTkFrame):
    ...
    def _populate_rows(self, clear=False):
        ...
        # [PERFORMANCE] Widget pooling: Derive start_idx logically rather than using len(widgets)
        # because the widgets dictionary now acts as a persistent cache across searches.
