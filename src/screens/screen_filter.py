...
class ScreenFilter(ctk.CTkFrame):
    ...
    def __init__(self, master, app):
        ...
        # True Widget Pool: list of generic row widgets
        self._row_pool = []
    ...
    def _populate_rows(self, clear=False):
        ...
        # Performance optimization: pool widgets and use pack_forget
        if clear:
            for i in range(self._rendered_count):
