...
class ScreenUpload(ctk.CTkFrame):
    ...
    def _on_analyze(self):
        ...
        try:
            ...
            # Show a generic error message to prevent leaking system paths in the UI.
            error_msg = (
                "An error occurred while parsing the files. Please ensure you downloaded "
                "the correct Instagram data (JSON format, All Time) and try again."
            )
            ToastPopup(
                self.app,
                title="Parsing Error",
