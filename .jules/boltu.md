...
## 2026-06-09 - Pre-compile Regex in Loops
**Learning:** Compiling regex patterns (e.g. `re.compile()`) at the module level significantly reduces parsing and lookup overhead when used repeatedly in high-volume operations like parsing large arrays of usernames.
**Action:** Always pre-compile regex outside of loops or heavily invoked parsing functions when the pattern is static.
