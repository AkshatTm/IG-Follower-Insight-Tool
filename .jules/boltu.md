...
## 2026-06-13 - Pre-compile regex in tight loops
**Learning:** When performing regex substitutions inside high-volume operations (e.g., processing large arrays of JSON entries), explicitly pre-compile the regex at the module level using `re.compile()` to reduce parsing and lookup overhead.
**Action:** Always pre-compile regexes used inside loops to improve performance.
