...
## 2026-06-25 - Pre-compile regex for high-volume operations
**Learning:** Compiling regex inline inside a loop that executes millions of times creates unnecessary parsing and lookup overhead.
**Action:** Always pre-compile regex at the module level using `re.compile()` for operations inside loops handling large arrays or parsing tasks.
