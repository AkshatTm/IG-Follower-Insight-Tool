...
## 2026-05-17 - Regex Pre-compilation
**Learning:** Repeatedly compiling regexes in high-volume operations (e.g. processing large JSON arrays) degrades performance.
**Action:** Pre-compile regexes at the module level using re.compile().
