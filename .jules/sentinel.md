...
## 2026-07-01 - Prevent Information Leakage in Screen Upload
...
**Learning:** This could leak sensitive system information such as directory structures and local file paths if a system-level error occurs during parsing.
**Prevention:** Catch exceptions and log them to the console, but display a generic, sanitized error message to the user in the UI.
