...
## 2026-05-06 - [Error Message Information Leakage]
...
**Learning:** This could leak sensitive system information such as directory structures and local file paths (e.g., if a file operation error occurs, the full path is shown to the user).
**Prevention:** Catch exceptions and log them securely (like `print` to console), while displaying a generic, sanitized, user-friendly error message in the UI instead.
