...
## 2024-05-22 - Prevent Error Message Information Leakage
...
**Learning:** This could leak sensitive system information such as directory structures and local file paths.
**Prevention:** Catch exceptions and log them to the console, while displaying a generic, sanitized, user-friendly error message in the UI instead.
